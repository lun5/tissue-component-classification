...
component_list = {'carcinoma','fat','vessel','stroma','duct','lymphocyte','white space'};
...
% no_dims = 3; initial_dims = 20; perpexity = 30;
% D = squareform(pdist(all_features_matrix,'cosine'));
% mappedX = tsne(all_features_matrix,[],no_dims,initial_dims, perpexity);
...
% hold on
% for i = 1:5:length(all_features_matrix)
