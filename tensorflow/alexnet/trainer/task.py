...
flags.DEFINE_string('model_dir', '/home/lun5/ADH/tensorflow/ADH_non/alexnet/masked_images/model', 'Directory to put the model into.')
flags.DEFINE_string('train_output_dir', '/home/lun5/ADH/tensorflow/ADH_non/alexnet/masked_images/data', 'Directory containing output data')
...
#flags.DEFINE_string('model_dir', '/home/lun5/ADH/tensorflow/benign_malign/alexnet/non_masked_images/model', 'Directory to put the model into.')
#flags.DEFINE_string('train_output_dir', '/home/lun5/ADH/tensorflow/benign_malign/alexnet/non_masked_images/data', 'Directory containing output data')
...
if not os.path.isdir(FLAGS.train_output_dir):
