...
#flags.DEFINE_string('model_dir', '/home/lun5/ADH/tensorflow/benign_malign/overfeat/non_masked_images/model', 'Directory to put the model into.')
#flags.DEFINE_string('train_output_dir', '/home/lun5/ADH/tensorflow/benign_malign/overfeat/non_masked_images/data', 'Directory containing output data')
flags.DEFINE_string('model_dir', '/home/lun5/ADH/tensorflow/benign_malign/overfeat/masked_images/model', 'Directory to put the model into.')
flags.DEFINE_string('train_output_dir', '/home/lun5/ADH/tensorflow/benign_malign/overfeat/masked_images/data', 'Directory containing output data')
...
if __name__ == '__main__':   
  ...
  for (label, files) in examples:
      ...
      if (count%100== 0) and (count > 0):
          ...
          with open(os.path.join(FLAGS.model_dir,'eval_results.txt'), 'w') as fp:
