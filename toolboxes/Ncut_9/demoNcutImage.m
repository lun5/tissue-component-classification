...
raw_image = imread('Z:\TilesForLabeling_tiff_renamed\95f7k8loesyevi.tif');
mult = 4; I = raw_image(1:mult:end,1:mult:end,:);
opts_affinity = setEnvironment_affinity;
f_maps = getFeatures(double(I)./255,1,{'hue opp'},opts_affinity);
I = f_maps{1};
